...
function consumerMarkDirty(node) {
  ...
  (_a6 = node.consumerMarkedDirty) == null ? void 0 : _a6.call(node, node);
}
...
function consumerIsLive(node) {
  var _a6, _b2;
  return node.consumerIsAlwaysLive || ((_b2 = (_a6 = node == null ? void 0 : node.liveConsumerNode) == null ? void 0 : _a6.length) != null ? _b2 : 0) > 0;
}
function assertConsumerNode(node) {
  var _a6, _b2, _c2;
  (_a6 = node.producerNode) != null ? _a6 : node.producerNode = [];
...
function assertProducerNode(node) {
  var _a6, _b2;
  (_a6 = node.liveConsumerNode) != null ? _a6 : node.liveConsumerNode = [];
...
function removeEventListener(element, info) {
  if (element.removeEventListener) {
    ...
    element.detachEvent("on".concat(info.eventType), info.handler);
  }
}
...
var EventContractContainer = class {
  ...
  constructor(element) {
     ...
     *
     */
    __publicField(this, "handlerInfos", []);
...
var ActionResolver = class {
  constructor({
    ...
    __publicField(this, "a11yClickSupport", false);
    __publicField(this, "clickModSupport", true);
    __publicField(this, "syntheticMouseEventSupport");
    __publicField(this, "updateEventInfoForA11yClick");
    __publicField(this, "preventDefaultForA11yClick");
    __publicField(this, "populateClickOnlyAction");
  ...
  getParentNode(element) {
    ...
    if ((parentNode == null ? void 0 : parentNode.nodeName) === "#document-fragment") {
      return (_a6 = parentNode == null ? void 0 : parentNode.host) != null ? _a6 : null;
    }
    return parentNode;
  }
  /**
...
var Dispatcher = class {
  ...
  constructor(dispatchDelegate, {
    ...
    __publicField(this, "dispatchDelegate");
    // The ActionResolver to use to resolve actions.
    __publicField(this, "actionResolver");
    /** The replayer function to be called when there are queued events. */
    __publicField(this, "eventReplayer");
    /** Whether the event replay is scheduled. */
    __publicField(this, "eventReplayScheduled", false);
    /** The queue of events. */
    __publicField(this, "replayEventInfoWrappers", []);
  ...
  dispatch(eventInfo) {
    ...
    (_a6 = this.actionResolver) == null ? void 0 : _a6.resolveEventType(eventInfo);
...
var EventDispatcher = class {
  constructor(dispatchDelegate, clickModSupport = true) {
    __publicField(this, "dispatchDelegate");
    __publicField(this, "clickModSupport");
    __publicField(this, "actionResolver");
...
function prepareEventForDispatch(eventInfoWrapper) {
  var _a6;
  const event = eventInfoWrapper.getEvent();
  const currentTarget = (_a6 = eventInfoWrapper.getAction()) == null ? void 0 : _a6.element;
  if (currentTarget) {
...
function getQueuedEventInfos(earlyJsactionData) {
  var _a6;
  return (_a6 = earlyJsactionData == null ? void 0 : earlyJsactionData.q) != null ? _a6 : [];
}
...
var _EventContract = class _EventContract {
  constructor(containerManager) {
    ...
    __publicField(this, "browserEventTypeToExtraEventTypes", {});
    /**
     ...
     */
    __publicField(this, "queuedEventInfos", []);
  ...
  handleEventInfo(eventInfo) {
    ...
    if (!this.dispatcher) {
      ...
      (_a6 = this.queuedEventInfos) == null ? void 0 : _a6.push(eventInfo);
      return;
    }
  ...
  cleanUp() {
    var _a6;
    (_a6 = this.containerManager) == null ? void 0 : _a6.cleanUp();
  ...
  ecrd(dispatcher, restriction) {
    ...
    if ((_a6 = this.queuedEventInfos) == null ? void 0 : _a6.length) {
...
function getAppScopedQueuedEventInfos(appId, dataContainer = window) {
  var _a6;
  return getQueuedEventInfos((_a6 = dataContainer._ejsas) == null ? void 0 : _a6[appId]);
}
...
function formatRuntimeErrorCode(code) {
  return "NG0".concat(Math.abs(code));
}
...
function createInputSignal(initialValue, options) {
  ...
  function inputValueFn() {
    ...
    if (node.value === REQUIRED_UNSET_VALUE) {
      let message = null;
      if (ngDevMode) {
        const name = (_a6 = options == null ? void 0 : options.debugName) != null ? _a6 : options == null ? void 0 : options.alias;
        message = "Input".concat(name ? ' "'.concat(name, '"') : "", " is required but no value is available yet.");
      }
  ...
  if (ngDevMode) {
    inputValueFn.toString = () => "[Input Signal: ".concat(inputValueFn(), "]");
...
function stringify(token) {
  ...
  if (Array.isArray(token)) {
    return "[".concat(token.map(stringify).join(", "), "]");
  }
  if (token == null) {
    return "" + token;
  }
...
function concatStringsWithSpace(before, after) {
  ...
  return "".concat(before, " ").concat(after);
}
...
function assertElement(node) {
  if (!(node instanceof Element)) {
    throwError("The provided value must be an element but got ".concat(stringify(node)));
  }
}
...
function assertNotReactive(fn) {
  if (getActiveConsumer() !== null) {
    throwError("".concat(fn, "() should never be called in a reactive context."));
  }
}
...
function throwCyclicDependencyError(token, path) {
  throw new RuntimeError(-200, ngDevMode ? "Circular dependency in DI detected for ".concat(token).concat(path ? ". Dependency path: ".concat(path.join(" > "), " > ").concat(token) : "") : token);
}
...
function injectInjectorOnly(token, flags = InjectFlags.Default) {
  if (getCurrentInjector() === void 0) {
    throw new RuntimeError(-203, ngDevMode && "The `".concat(stringify(token), "` token injection failed. `inject()` function must be called from an injection context such as a constructor, a factory function, a field initializer, or a function used with `runInInjectionContext`."));
...
function requiresRefreshOrTraversal(lView) {
  var _a6;
  return !!(lView[FLAGS] & (1024 | 8192) || ((_a6 = lView[REACTIVE_TEMPLATE_CONSUMER]) == null ? void 0 : _a6.dirty));
}
function updateAncestorTraversalFlagsOnAttach(lView) {
  var _a6;
  (_a6 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a6.notify(8);
  if (lView[FLAGS] & 64) {
    lView[FLAGS] |= 1024;
  }
...
function markAncestorsForTraversal(lView) {
  var _a6;
  (_a6 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a6.notify(0);
...
function getOrCreateLViewCleanup(view) {
  var _a6;
  return (_a6 = view[CLEANUP]) != null ? _a6 : view[CLEANUP] = [];
}
function getOrCreateTViewCleanup(tView) {
  var _a6;
  return (_a6 = tView.cleanup) != null ? _a6 : tView.cleanup = [];
}
...
function registerPreOrderHooks(directiveIndex, directiveDef, tView) {
  ...
  if (ngOnChanges) {
    ...
    ((_a6 = tView.preOrderHooks) != null ? _a6 : tView.preOrderHooks = []).push(directiveIndex, wrappedOnChanges);
...
function registerPostOrderHooks(tView, tNode) {
  ...
  for (let i = tNode.directiveStart, end = tNode.directiveEnd; i < end; i++) {
    ...
    if (ngAfterContentInit) {
      ((_a6 = tView.contentHooks) != null ? _a6 : tView.contentHooks = []).push(-i, ngAfterContentInit);
    }
...
var _Injector = class _Injector {
  static create(options, parent) {
    ...
    if (Array.isArray(options)) {
      ...
      const name = (_a6 = options.name) != null ? _a6 : "";
      return createInjector({
        name
...
var HostAttributeToken = class {
  constructor(attributeName) {
    ...
    /** @internal */
    __publicField(this, "__NG_ELEMENT_ID__", () => ɵɵinjectAttribute(this.attributeName));
    this.attributeName = attributeName;
  }
  toString() {
    return "HostAttributeToken ".concat(this.attributeName);
  }
};
...
HOST_TAG_NAME.__NG_ELEMENT_ID__ = (flags) => {
  ...
  throw new RuntimeError(204, ngDevMode && "HOST_TAG_NAME was used on ".concat(getDevModeNodeName(tNode), " which doesn't have an underlying element in the DOM. ") + "This is invalid, and so the dependency should be marked as optional.");
};
...
var _PendingTasks = class _PendingTasks {
  constructor() {
    __publicField(this, "internalPendingTasks", inject(PendingTasksInternal));
    __publicField(this, "scheduler", inject(ChangeDetectionScheduler));
  }
  /**
...
var EventEmitter_ = class extends Subject {
  constructor(isAsync = false) {
    ...
    if (isInInjectionContext()) {
      this.destroyRef = (_a6 = inject(DestroyRef, {
        optional: true
      })) != null ? _a6 : void 0;
  ...
  subscribe(observerOrNext, error, complete) {
    ...
    if (observerOrNext && typeof observerOrNext === "object") {
      ...
      nextFn = (_a6 = observer.next) == null ? void 0 : _a6.bind(observer);
  ...
  wrapInTimeout(fn) {
    return (value) => {
      var _a6;
      const taskId = (_a6 = this.pendingTasks) == null ? void 0 : _a6.add();
      setTimeout(() => {
        var _a7;
        try {
          fn(value);
          ...
          if (taskId !== void 0) {
            (_a7 = this.pendingTasks) == null ? void 0 : _a7.remove(taskId);
          }
        }
      });
    };
...
var AsyncStackTaggingZoneSpec = class {
  constructor(namePrefix, consoleAsyncStackTaggingImpl = console) {
    ...
    this.createTask = (_a6 = consoleAsyncStackTaggingImpl == null ? void 0 : consoleAsyncStackTaggingImpl.createTask) != null ? _a6 : () => null;
  }
...
function hasApplyArgsData(applyArgs, key) {
  ...
  return ((_b2 = (_a6 = applyArgs[0]) == null ? void 0 : _a6.data) == null ? void 0 : _b2[key]) === true;
}
...
var OutputEmitterRef = class {
  constructor() {
    ...
    __publicField(this, "errorHandler", inject(ErrorHandler, {
      optional: true
    }));
    /** @internal */
  ...
  subscribe(callback) {
    ...
    ((_a6 = this.listeners) != null ? _a6 : this.listeners = []).push(callback);
    return {
      unsubscribe: () => {
        var _a7, _b2;
        const idx = (_a7 = this.listeners) == null ? void 0 : _a7.indexOf(callback);
        if (idx !== void 0 && idx !== -1) {
    ...
    try {
      for (const listenerFn of this.listeners) {
        try {
          ...
          (_a6 = this.errorHandler) == null ? void 0 : _a6.handleError(err);
        }
      }
    } finally {
...
function signal(initialValue, options) {
  ...
  if (ngDevMode) {
    signalFn.toString = () => "[Signal: ".concat(signalFn(), "]");
    node.debugName = options == null ? void 0 : options.debugName;
  }
  return signalFn;
}
...
var QueryList = class {
  ...
  get changes() {
    var _a6;
    return (_a6 = this._changes) != null ? _a6 : this._changes = new Subject();
  }
  /**
  ...
  setDirty() {
    var _a6;
    this.dirty = true;
    (_a6 = this._onDirty) == null ? void 0 : _a6.call(this);
  }
  /** internal */
  destroy() {
...
var CSP_NONCE = new InjectionToken(ngDevMode ? "CSP nonce" : "", {
  ...
  factory: () => {
    var _a6, _b2;
    return ((_b2 = (_a6 = getDocument().body) == null ? void 0 : _a6.querySelector("[ngCspNonce]")) == null ? void 0 : _b2.getAttribute("ngCspNonce")) || null;
  }
});
...
function performanceMarkFeature(feature) {
  ...
  (_a6 = performance == null ? void 0 : performance.mark) == null ? void 0 : _a6.call(performance, "mark_feature_usage", {
    detail: {
      feature
    }
  });
...
var _AfterRenderManager = class _AfterRenderManager {
  ...
  execute() {
    var _a6;
    (_a6 = this.impl) == null ? void 0 : _a6.execute();
  }
};
/** @nocollapse */
__publicField(
...
var _AfterRenderImpl = class _AfterRenderImpl {
  ...
  register(sequence) {
    ...
    if (view !== void 0) {
      ((_a6 = view[AFTER_RENDER_SEQUENCES_TO_ADD]) != null ? _a6 : view[AFTER_RENDER_SEQUENCES_TO_ADD] = []).push(sequence);
...
var AfterRenderSequence = class {
  ...
  afterRun() {
    ...
    (_a6 = this.snapshot) == null ? void 0 : _a6.dispose();
    this.snapshot = null;
  }
  destroy() {
    var _a6, _b2;
    this.impl.unregister(this);
    (_a6 = this.unregisterOnDestroy) == null ? void 0 : _a6.call(this);
...
function afterRender(callbackOrSpec, options) {
  ...
  const injector = (_a6 = options == null ? void 0 : options.injector) != null ? _a6 : inject(Injector);
  if (false) {
...
function afterRenderImpl(callbackOrSpec, injector, options, once) {
  ...
  (_a6 = manager.impl) != null ? _a6 : manager.impl = injector.get(AfterRenderImpl);
...
function getTemplateIndexForState(newState, hostLView, tNode) {
  ...
  switch (newState) {
    ...
    default:
      ngDevMode && throwError("Unexpected defer block state: ".concat(newState));
      return null;
  }
}
function getMinimumDurationForState(tDetails, currentState) {
  ...
  if (currentState === DeferBlockState.Placeholder) {
    return (_b2 = (_a6 = tDetails.placeholderBlockConfig) == null ? void 0 : _a6[MINIMUM_SLOT]) != null ? _b2 : null;
...
function getLoadingBlockAfter(tDetails) {
  var _a6, _b2;
  return (_b2 = (_a6 = tDetails.loadingBlockConfig) == null ? void 0 : _a6[LOADING_AFTER_SLOT]) != null ? _b2 : null;
}
...
function trackTriggerForDebugging(tView, tNode, textRepresentation) {
  var _a6, _b2, _c2;
  const tDetails = getTDeferBlockDetails(tView, tNode);
  (_a6 = tDetails.debug) != null ? _a6 : tDetails.debug = {};
...
function getTriggerLView(deferredHostLView, deferredTNode, walkUpTimes) {
  ...
  const triggerLView = (_a6 = deferredContainer[CONTAINER_HEADER_OFFSET]) != null ? _a6 : null;
...
function setJSActionAttributes(nativeElement, eventTypes, parentDeferBlockId = null) {
  ...
  const parts = eventTypes.reduce((prev, curr) => {
    var _a6;
    return ((_a6 = existingAttr == null ? void 0 : existingAttr.indexOf(curr)) != null ? _a6 : -1) === -1 ? prev + curr + ":;" : prev;
  }, "");
  nativeElement.setAttribute(Attribute.JSACTION, "".concat(existingAttr != null ? existingAttr : "").concat(parts));
...
var sharedStashFunction = (rEl, eventType, listenerFn) => {
  var _a6, _b2;
  const el = rEl;
  const eventListenerMap = (_a6 = el.__jsaction_fns) != null ? _a6 : /* @__PURE__ */ new Map();
...
var sharedMapFunction = (rEl, jsActionMap) => {
  var _a6, _b2;
  const el = rEl;
  let blockName = (_a6 = el.getAttribute(DEFER_BLOCK_SSR_ID_ATTRIBUTE)) != null ? _a6 : "";
...
function invokeListeners(event, currentTarget) {
  var _a6;
  const handlerFns = (_a6 = currentTarget == null ? void 0 : currentTarget.__jsaction_fns) == null ? void 0 : _a6.get(event.type);
...
var _DehydratedBlockRegistry = class _DehydratedBlockRegistry {
  constructor() {
    ...
    __publicField(this, "jsActionMap", inject(JSACTION_BLOCK_ELEMENT_MAP));
    __publicField(this, "contract", inject(JSACTION_EVENT_CONTRACT));
  ...
  get(blockId) {
    var _a6;
    return (_a6 = this.registry.get(blockId)) != null ? _a6 : null;
  }
  has(blockId) {
  ...
  cleanup(hydratedBlocks) {
    ...
    if (this.size === 0) {
      (_a6 = this.contract.instance) == null ? void 0 : _a6.cleanUp();
    }
  }
  get size() {
  ...
  invokeTriggerCleanupFns(blockId) {
    var _a6;
    const fns = (_a6 = this.cleanupFns.get(blockId)) != null ? _a6 : [];
    for (let fn of fns) {
      fn();
    }
  ...
  awaitParentBlock(topmostParentBlock, callback) {
    var _a6;
    const parentBlockAwaitCallbacks = (_a6 = this.awaitingCallbacks.get(topmostParentBlock)) != null ? _a6 : [];
...
function retrieveHydrationInfoImpl(rNode, injector, isRootView2 = false) {
  ...
  const dehydratedView = {
    data,
    firstChild: (_a6 = rNode.firstChild) != null ? _a6 : null
  };
  if (isRootView2) {
...
function getTextNodeContent(node) {
  var _a6;
  return (_a6 = node.textContent) == null ? void 0 : _a6.replace(/\s/gm, "");
}
...
function readHydrationInfo(node) {
  var _a6;
  return (_a6 = node[HYDRATION_INFO_KEY]) != null ? _a6 : null;
}
...
function isRNodeClaimedForHydration(node) {
  var _a6;
  return ((_a6 = readHydrationInfo(node)) == null ? void 0 : _a6.status) === HydrationStatus.Hydrated;
}
function setSegmentHead(hydrationInfo, index, node) {
  var _a6;
  (_a6 = hydrationInfo.segmentHeads) != null ? _a6 : hydrationInfo.segmentHeads = {};
  hydrationInfo.segmentHeads[index] = node;
}
function getSegmentHead(hydrationInfo, index) {
  var _a6, _b2;
  return (_b2 = (_a6 = hydrationInfo.segmentHeads) == null ? void 0 : _a6[index]) != null ? _b2 : null;
}
...
function getNgContainerSize(hydrationInfo, index) {
  ...
  let size = (_b2 = (_a6 = data[ELEMENT_CONTAINERS]) == null ? void 0 : _a6[index]) != null ? _b2 : null;
...
function isSerializedElementContainer(hydrationInfo, index) {
  var _a6;
  return ((_a6 = hydrationInfo.data[ELEMENT_CONTAINERS]) == null ? void 0 : _a6[index]) !== void 0;
}
function getSerializedContainerViews(hydrationInfo, index) {
  var _a6, _b2;
  return (_b2 = (_a6 = hydrationInfo.data[CONTAINERS]) == null ? void 0 : _a6[index]) != null ? _b2 : null;
}
function calcSerializedContainerSize(hydrationInfo, index) {
  var _a6, _b2;
  const views = (_a6 = getSerializedContainerViews(hydrationInfo, index)) != null ? _a6 : [];
  let numNodes = 0;
...
function isDisconnectedNode$1(hydrationInfo, index) {
  ...
  return !!((_a6 = initDisconnectedNodes(hydrationInfo)) == null ? void 0 : _a6.has(index));
}
function processTextNodeBeforeSerialization(context, node) {
  ...
  } else if (((_a6 = el.nextSibling) == null ? void 0 : _a6.nodeType) === Node.TEXT_NODE) {
    corruptedTextNodes.set(
      el,
      "ngtns"
...
function getHydrateTimerTrigger(blockData) {
  var _a6, _b2;
  const trigger = (_a6 = blockData[DEFER_HYDRATE_TRIGGERS]) == null ? void 0 : _a6.find((t) => isTimerTrigger(t));
  return (_b2 = trigger == null ? void 0 : trigger.delay) != null ? _b2 : null;
}
function hasHydrateTrigger(blockData, trigger) {
  var _a6, _b2;
  return (_b2 = (_a6 = blockData[DEFER_HYDRATE_TRIGGERS]) == null ? void 0 : _a6.includes(trigger)) != null ? _b2 : false;
}
...
function isSsrContentsIntegrity(node) {
  var _a6;
  return !!node && node.nodeType === Node.COMMENT_NODE && ((_a6 = node.textContent) == null ? void 0 : _a6.trim()) === SSR_CONTENT_INTEGRITY_MARKER;
}
...
function trustedHTMLFromString(html) {
  var _a6;
  return ((_a6 = getPolicy$1()) == null ? void 0 : _a6.createHTML(html)) || html;
}
function trustedScriptURLFromString(url) {
  var _a6;
  return ((_a6 = getPolicy$1()) == null ? void 0 : _a6.createScriptURL(url)) || url;
}
var policy;
function getPolicy() {
  if (policy === void 0) {
...
function trustedHTMLFromStringBypass(html) {
  var _a6;
  return ((_a6 = getPolicy()) == null ? void 0 : _a6.createHTML(html)) || html;
}
function trustedScriptFromStringBypass(script) {
  var _a6;
  return ((_a6 = getPolicy()) == null ? void 0 : _a6.createScript(script)) || script;
}
function trustedScriptURLFromStringBypass(url) {
  var _a6;
  return ((_a6 = getPolicy()) == null ? void 0 : _a6.createScriptURL(url)) || url;
}
...
var DOMParserHelper = class {
  ...
  getInertBodyElement(html) {
    ...
    try {
      ...
      (_a6 = body.firstChild) == null ? void 0 : _a6.remove();
      return body;
    } catch {
      return null;
    }
...
function clobberedElementError(node) {
  return new Error("Failed to sanitize html because the element is clobbered: ".concat(node.outerHTML));
}
...
function getTemplateLocationDetails(lView) {
  ...
  const componentClassName = (_a6 = hostComponentDef == null ? void 0 : hostComponentDef.type) == null ? void 0 : _a6.name;
...
function throwMultipleComponentError(tNode, first, second) {
  throw new RuntimeError(-300, "Multiple components match node with tagname ".concat(tNode.value, ": ") + "".concat(stringifyForError(first), " and ") + "".concat(stringifyForError(second)));
}
  ...
  try {
    if (ngDevMode) {
      if (!def.inputs.hasOwnProperty(publicName)) {
        throw new Error("ASSERTION ERROR: Directive ".concat(def.type.name, ' does not have an input with a public name of "').concat(publicName, '"'));
      }
      if (instance instanceof NodeInjectorFactory) {
        throw new Error("ASSERTION ERROR: Cannot write input to factory for type ".concat(def.type.name, ". Directive has not been created yet."));
      }
    }
...
function setNgReflectProperty(lView, tNode, attrName, value) {
  ...
  if (tNode.type & 3) {
    ...
    const textContent = escapeCommentText("bindings=".concat(JSON.stringify({
      [attrName]: debugValue
    }, null, 2)));
...
function setNgReflectProperties(lView, tView, tNode, publicName, value) {
  ...
  const inputConfig = (_a6 = tNode.inputs) == null ? void 0 : _a6[publicName];
...
function storePropertyBindingMetadata(tData, tNode, propertyName, bindingIndex, ...interpolationParts) {
  ...
  if (tData[bindingIndex] === null) {
    if (!((_a6 = tNode.inputs) == null ? void 0 : _a6[propertyName]) && !((_b2 = tNode.hostDirectiveInputs) == null ? void 0 : _b2[propertyName])) {
...
function setAllInputsForProperty(tNode, tView, lView, publicName, value) {
  var _a6, _b2;
  const inputs = (_a6 = tNode.inputs) == null ? void 0 : _a6[publicName];
...
function renderView(tView, lView, context) {
  ...
  try {
    ...
    (_a6 = lView[QUERIES]) == null ? void 0 : _a6.finishViewCreation(tView);
...
function createAndRenderEmbeddedLView(declarationLView, templateTNode, context, options) {
  ...
  try {
    ...
    const embeddedLView = createLView(declarationLView, embeddedTView, context, viewFlags, null, templateTNode, null, null, (_a6 = options == null ? void 0 : options.injector) != null ? _a6 : null, (_b2 = options == null ? void 0 : options.embeddedViewInjector) != null ? _b2 : null, (_c2 = options == null ? void 0 : options.dehydratedView) != null ? _c2 : null);
...
function detachViewFromDOM(tView, lView) {
  var _a6;
  (_a6 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a6.notify(9);
...
function getOrBorrowReactiveLViewConsumer(lView) {
  var _a6;
  return (_a6 = lView[REACTIVE_TEMPLATE_CONSUMER]) != null ? _a6 : borrowReactiveLViewConsumer(lView);
}
function borrowReactiveLViewConsumer(lView) {
  var _a6;
  const consumer = (_a6 = freeConsumers.pop()) != null ? _a6 : Object.create(REACTIVE_LVIEW_CONSUMER_NODE);
...
function getOrCreateTemporaryConsumer(lView) {
  var _a6;
  const consumer = (_a6 = lView[REACTIVE_TEMPLATE_CONSUMER]) != null ? _a6 : Object.create(TEMPORARY_CONSUMER_NODE);
  consumer.lView = lView;
  return consumer;
}
...
function detectChangesInternal(lView, notifyErrorHandler = true, mode = 0) {
  ...
  if (!checkNoChangesMode) {
    (_a6 = rendererFactory.begin) == null ? void 0 : _a6.call(rendererFactory);
  }
  try {
...
function markViewDirty(lView, source) {
  ...
  (_a6 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a6.notify(source);
  while (lView) {
...
var R3TemplateRef = class TemplateRef2 extends ViewEngineTemplateRef {
  ...
  get ssrId() {
    var _a6;
    return ((_a6 = this._declarationTContainer.tView) == null ? void 0 : _a6.ssrId) || null;
  }
...
function describeRNode(rNode, innerContent = "…") {
  ...
  switch (node.nodeType) {
    ...
    case Node.COMMENT_NODE:
      return "<!-- ".concat(shorten((_a6 = node.textContent) != null ? _a6 : ""), " -->");
    default:
...
function isFirstElementInNgContainer(tNode) {
  var _a6;
  return !tNode.prev && ((_a6 = tNode.parent) == null ? void 0 : _a6.type) === 8;
}
...
function locateNextRNode(hydrationInfo, tView, lView, tNode) {
  ...
  if (native === void 0) {
    ...
    if (nodes == null ? void 0 : nodes[noOffsetIndex]) {
      ...
      const previousTNode = (_a6 = tNode.prev) != null ? _a6 : tNode.parent;
...
function gatherDeferBlocksCommentNodes(doc, node) {
  ...
  while (currentNode = commentNodesIterator.nextNode()) {
    ...
    const nghIdx = (_a6 = content == null ? void 0 : content.indexOf(nghPattern)) != null ? _a6 : -1;
    if (nghIdx > -1) {
...
function acceptNode(node) {
  var _a6;
  return ((_a6 = node.textContent) == null ? void 0 : _a6.trimStart().startsWith("ngh=")) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT;
}
...
function getFirstNativeNodeForI18nNode(lView, node) {
  ...
  if (isTNodeShape(maybeTNode)) {
    ...
    return (_a6 = unwrapRNode(lView[node.index])) != null ? _a6 : null;
  }
}
...
function skipSiblingNodes(state, skip) {
  ...
  for (let i = 0; i < skip; i++) {
    ...
    currentNode = (_a6 = currentNode == null ? void 0 : currentNode.nextSibling) != null ? _a6 : null;
  }
  return currentNode;
}
...
function prepareI18nBlockForHydrationImpl(lView, index, parentTNode, subTemplateIndex) {
  ...
  const disconnectedNodes = (_a6 = initDisconnectedNodes(hydrationInfo)) != null ? _a6 : /* @__PURE__ */ new Set();
  ...
  if (Array.isArray(nodeOrNodes)) {
    ...
    switch (nodeOrNodes.kind) {
      case 0: {
        ...
        setCurrentNode(state, (_a6 = currentNode == null ? void 0 : currentNode.nextSibling) != null ? _a6 : null);
        break;
      }
      case 1: {
...
function claimDehydratedIcuCaseImpl(lView, icuIndex, caseIndex) {
  var _a6;
  const dehydratedIcuDataMap = (_a6 = lView[HYDRATION]) == null ? void 0 : _a6.dehydratedIcuData;
...
function removeDehydratedViews(lContainer) {
  var _a6;
  const views = (_a6 = lContainer[DEHYDRATED_VIEWS]) != null ? _a6 : [];
...
function locateDehydratedViewsInContainer(currentRNode, serializedViews) {
  ...
  for (const serializedView of serializedViews) {
    for (let i = 0; i < ((_a6 = serializedView[MULTIPLIER]) != null ? _a6 : 1); i++) {
      const view = {
        data: serializedView,
        firstChild: null
      };
...
var _NullComponentFactoryResolver = class {
  resolveComponentFactory(component) {
    throw Error("No component factory found for ".concat(stringify(component), "."));
  }
};
var _a2;
var ComponentFactoryResolver$1 = (_a2 = class {
}, __publicField(_a2, "NULL", new _NullComponentFactoryResolver()), _a2);
...
function cacheMatchingLocalNames(tNode, localRefs, exportsMap) {
  ...
  for (let i = 0; i < localRefs.length; i += 2) {
    ...
    if (index == null) throw new RuntimeError(-301, ngDevMode && "Export of name '".concat(localRefs[i + 1], "' not found!"));
...
function markAsComponentHost(tView, hostTNode, componentOffset) {
  ...
  ((_a6 = tView.components) != null ? _a6 : tView.components = []).push(hostTNode.index);
}
function initializeDirectives(tView, lView, tNode, directives, exportsMap, hostDirectiveDefs, hostDirectiveRanges) {
  ...
  for (let i = 0; i < directivesLength; i++) {
    ...
    if (!preOrderHooksFound && (lifeCycleHooks.ngOnChanges || lifeCycleHooks.ngOnInit || lifeCycleHooks.ngDoCheck)) {
      ((_a6 = tView.preOrderHooks) != null ? _a6 : tView.preOrderHooks = []).push(tNode.index);
...
function setupSelectorMatchedInputsOrOutputs(mode, tNode, def, directiveIndex) {
  ...
  for (const publicName in aliasMap) {
    if (aliasMap.hasOwnProperty(publicName)) {
      let bindings;
      if (mode === 0) {
        bindings = (_a6 = tNode.inputs) != null ? _a6 : tNode.inputs = {};
      } else {
...
function setupHostDirectiveInputsOrOutputs(mode, tNode, config, directiveIndex) {
  ...
  for (const initialName in aliasMap) {
    if (aliasMap.hasOwnProperty(initialName)) {
      ...
      let bindings;
      if (mode === 0) {
        bindings = (_a6 = tNode.hostDirectiveInputs) != null ? _a6 : tNode.hostDirectiveInputs = {};
      } else {
...
function setupInitialInputs(tNode, directiveIndex, isHostDirective) {
  ...
  isInlineTemplate(tNode)) {
    (_a6 = tNode.initialInputs) != null ? _a6 : tNode.initialInputs = [];
...
function verifyNotAnOrphanComponent(componentDef) {
  var _a6;
  if ((typeof ngJitMode === "undefined" || ngJitMode) && ((_a6 = componentDef.debugInfo) == null ? void 0 : _a6.forbidOrphanRendering)) {
    if (depsTracker.isOrphanComponent(componentDef.type)) {
      throw new RuntimeError(981, "Orphan component found! Trying to render the component ".concat(debugStringifyTypeForError(componentDef.type), " without first loading the NgModule that declares it. It is recommended to make this component standalone in order to avoid this error. If this is not possible now, import the component's NgModule in the appropriate NgModule, or the standalone component in which you are trying to render this component. If this is a lazy import, load the NgModule lazily as well and use its module injector."));
    }
  }
}
...
var ComponentFactory2 = class extends ComponentFactory$1 {
  ...
  constructor(componentDef, ngModule) {
    ...
    this.ngContentSelectors = (_a6 = componentDef.ngContentSelectors) != null ? _a6 : [];
    this.isBoundToModule = !!ngModule;
  }
  get inputs() {
    var _a6;
    (_a6 = this.cachedInputs) != null ? _a6 : this.cachedInputs = toInputRefArray(this.componentDef.inputs);
    return this.cachedInputs;
  }
  get outputs() {
    var _a6;
    (_a6 = this.cachedOutputs) != null ? _a6 : this.cachedOutputs = toOutputRefArray(this.componentDef.outputs);
...
var ComponentRef2 = class extends ComponentRef$1 {
  ...
  setInput(name, value) {
    ...
    (_a6 = this.previousInputValues) != null ? _a6 : this.previousInputValues = /* @__PURE__ */ new Map();
...
var R3ViewContainerRef = class ViewContainerRef2 extends VE_ViewContainerRef {
  ...
  createComponent(componentFactoryOrType, indexOrOptions, injector, projectableNodes, environmentInjector) {
    ...
    const componentDef = getComponentDef((_a6 = componentFactory.componentType) != null ? _a6 : {});
...
function populateDehydratedViewsInLContainerImpl(lContainer, tNode, hostLView) {
  ...
  const serializedViews = (_a6 = hydrationInfo.data[CONTAINERS]) == null ? void 0 : _a6[noOffsetIndex];
...
function createLQuery(tView, lView, flags) {
  ...
  const lQueries = ((_a6 = lView[QUERIES]) != null ? _a6 : lView[QUERIES] = new LQueries_()).queries;
...
function createModelSignal(initialValue, opts) {
  ...
  if (ngDevMode) {
    getter.toString = () => "[Model Signal: ".concat(getter(), "]");
    node.debugName = opts == null ? void 0 : opts.debugName;
  }
  return getter;
}
...
function resolveComponentResources(resourceResolver) {
  ...
  componentResourceResolutionQueue.forEach((component, type) => {
    ...
    if (component.styleUrl && ((_a6 = component.styleUrls) == null ? void 0 : _a6.length)) {
...
function ɵɵdefineComponent(componentDefinition) {
  return noSideEffects(() => {
    ...
    const def = __spreadProps(__spreadValues({}, baseDef), {
      ...
      signals: (_a6 = componentDefinition.signals) != null ? _a6 : false,
  ...
  for (const minifiedKey in obj) {
    if (obj.hasOwnProperty(minifiedKey)) {
      ...
      if (Array.isArray(value)) {
        inputFlags = value[0];
        publicName = value[1];
        declaredName = (_a6 = value[2]) != null ? _a6 : publicName;
...
function ɵɵdefinePipe(pipeDef) {
  ...
  return {
    ...
    standalone: (_a6 = pipeDef.standalone) != null ? _a6 : true,
...
function getNgDirectiveDef(directiveDefinition) {
  ...
  return {
    ...
    standalone: (_a6 = directiveDefinition.standalone) != null ? _a6 : true,
...
function initFeatures(definition) {
  var _a6;
  (_a6 = definition.features) == null ? void 0 : _a6.forEach((fn) => fn(definition));
}
...
function locateOrCreateContainerAnchorImpl(tView, lView, tNode, index) {
  ...
  const ssrId = (_b2 = (_a6 = hydrationInfo.data[TEMPLATES]) == null ? void 0 : _a6[index]) != null ? _b2 : null;
...
function renderDeferBlockState(newState, tNode, lContainer, skipTimerScheduling = false) {
  ...
  if (isValidStateChange(currentState, newState) && isValidStateChange((_a6 = lDetails[NEXT_DEFER_BLOCK_STATE]) != null ? _a6 : -1, newState)) {
...
function findMatchingDehydratedViewForDeferBlock(lContainer, lDetails) {
  var _a6, _b2;
  const dehydratedViewIx = (_b2 = (_a6 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a6.findIndex((view) => view.data[DEFER_BLOCK_STATE$1] === lDetails[DEFER_BLOCK_STATE])) != null ? _b2 : -1;
...
function applyDeferBlockState(newState, lDetails, lContainer, tNode, hostLView) {
  ...
  if (stateTmplIndex !== null) {
    ...
    if (dehydratedViewIx > -1) {
      (_a6 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a6.splice(dehydratedViewIx, 1);
    }
...
function getAsyncClassMetadataFn(type) {
  ...
  return (_a6 = componentClass[ASYNC_COMPONENT_METADATA_FN]) != null ? _a6 : null;
}
...
function getDeferBlocks(node) {
  var _a6;
  const results = [];
  const lView = (_a6 = getLContext(node)) == null ? void 0 : _a6.lView;
  if (lView) {
  ...
  for (const details of blocks) {
    ...
    const data = {
      ...
      loadingBlock: {
        ...
        minimumTime: (_b2 = (_a6 = tDetails.loadingBlockConfig) == null ? void 0 : _a6[MINIMUM_SLOT]) != null ? _b2 : null,
...
function getDependenciesForTokenInInjector(token, injector) {
  ...
  if (!(injector instanceof NodeInjector)) {
    return (_c2 = (_b2 = (_a6 = resolverToTokenToDependencies.get(injector)) == null ? void 0 : _a6.get) == null ? void 0 : _b2.call(_a6, token)) != null ? _c2 : [];
  }
  const lView = getNodeInjectorLView(injector);
  ...
  return dependencies.filter((dependency) => {
    var _a7;
    const dependencyNode = (_a7 = dependency.injectedIn) == null ? void 0 : _a7.tNode;
...
function getNodeInjectorProviders(injector) {
  ...
  return (_a6 = resolverToProviders.get(diResolver)) != null ? _a6 : [];
}
    ...
    if (!visitedContainers.has(container)) {
      for (const prov of providerToPath.keys()) {
        ...
        deepForEach(containerDef.imports, (moduleImport) => {
          ...
          if (isNextStepInPath) {
            (_a6 = providerToPath.get(prov)) == null ? void 0 : _a6.unshift(container);
          }
        });
      }
    }
...
function getEnvironmentInjectorProviders(injector) {
  var _a6, _b2;
  const providerRecordsWithoutImportPaths = (_a6 = getFrameworkDIDebugData().resolverToProviders.get(injector)) != null ? _a6 : [];
...
function getInjectorMetadata(injector) {
  ...
  if (injector instanceof R3Injector) {
    return {
      type: "environment",
      source: (_a6 = injector.source) != null ? _a6 : null
    };
  }
...
function getInjectorParent(injector) {
  ...
  if (hasParentInjector(parentLocation)) {
    ...
    const injectorParent = (_a6 = chainedInjector.injector) == null ? void 0 : _a6.parent;
...
function getNodesAndEdgesFromSignalMap(signalMap) {
  ...
  for (const [consumer, producers] of signalMap.entries()) {
    ...
    if (isComputedNode(consumer) || isSignalNode(consumer)) {
      ...
      debugSignalGraphNodes.push({
        label: (_e = consumer.debugName) != null ? _e : (_d = (_c2 = (_b2 = (_a6 = consumer.lView) == null ? void 0 : _a6[HOST]) == null ? void 0 : _b2.tagName) == null ? void 0 : _c2.toLowerCase) == null ? void 0 : _d.call(_c2),
        kind: consumer.kind
      });
...
function extractEffectsFromInjector(injector) {
  ...
  const effects = (_a6 = resolverToEffects.get(diResolver)) != null ? _a6 : [];
...
function extractSignalNodesAndEdgesFromRoots(nodes, signalDependenciesMap = /* @__PURE__ */ new Map()) {
  ...
  for (const node of nodes) {
    ...
    const producerNodes = (_a6 = node.producerNode) != null ? _a6 : [];
...
function publishUtil(name, fn) {
  ...
  if (typeof COMPILED === "undefined" || !COMPILED) {
    ...
    (_a6 = w[GLOBAL_PUBLISH_EXPANDO_KEY]) != null ? _a6 : w[GLOBAL_PUBLISH_EXPANDO_KEY] = {};
...
var _Testability = class _Testability {
  constructor(_ngZone, registry, testabilityGetter) {
    ...
    if (isInInjectionContext()) {
      this._destroyRef = (_a6 = inject(DestroyRef, {
        optional: true
      })) != null ? _a6 : void 0;
    }
  ...
  _watchAngularEvents() {
    ...
    (_a6 = this._destroyRef) == null ? void 0 : _a6.onDestroy(() => {
...
var _TestabilityRegistry = class _TestabilityRegistry {
  ...
  findTestabilityInTree(elem, findInAncestors = true) {
    var _a6;
    return (_a6 = _testabilityGetter == null ? void 0 : _testabilityGetter.findTestabilityInTree(this, elem, findInAncestors)) != null ? _a6 : null;
  }
};
...
var _ApplicationInitStatus = class _ApplicationInitStatus {
  constructor() {
    ...
    __publicField(this, "appInits", (_a3 = inject(APP_INITIALIZER, {
      optional: true
    })) != null ? _a3 : []);
...
var _ApplicationRef = class _ApplicationRef {
  constructor() {
    ...
    __publicField(this, "tickImpl", () => {
      ...
      try {
        ...
        (_a6 = this.tracingSnapshot) == null ? void 0 : _a6.dispose();
  ...
  synchronizeOnce() {
    ...
    if (this.dirtyFlags & 7) {
      ...
      (_b2 = (_a6 = this._rendererFactory) == null ? void 0 : _a6.begin) == null ? void 0 : _b2.call(_a6);
...
function triggerResourceLoading(tDetails, lView, tNode) {
  ...
  const tView = lView[TVIEW];
  if (tDetails.loadingState !== DeferDependenciesLoadingState.NOT_STARTED) {
    return (_a6 = tDetails.loadingPromise) != null ? _a6 : Promise.resolve();
  }
  const lDetails = getLDeferBlockDetails(lView, tNode);
...
function triggerHydrationForBlockQueue(injector, hydrationQueue, replayQueuedEventsFn) {
  return __async(this, null, function* () {
    ...
    yield (_a6 = blocksBeingHydrated.get(lastBlockName)) == null ? void 0 : _a6.promise;
...
function cleanupRemainingHydrationQueue(hydrationQueue, dehydratedBlockRegistry) {
  ...
  for (const dehydratedBlockId in hydrationQueue) {
    (_a6 = blocksBeingHydrated.get(dehydratedBlockId)) == null ? void 0 : _a6.reject();
  }
...
function getHydrateTriggers(tView, tNode) {
  var _a6;
  const tDetails = getTDeferBlockDetails(tView, tNode);
  return (_a6 = tDetails.hydrateTriggers) != null ? _a6 : tDetails.hydrateTriggers = /* @__PURE__ */ new Map();
}
...
function ɵɵdefer(index, primaryTmplIndex, dependencyResolverFn, loadingTmplIndex, placeholderTmplIndex, errorTmplIndex, loadingConfigIndex, placeholderConfigIndex, enableTimerScheduling, flags) {
  ...
  if (((_a6 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a6.length) > 0) {
...
function ɵɵdeferOnTimer(delay) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "on timer(".concat(delay, "ms)"));
  }
  if (!shouldAttachTrigger(0, lView, tNode)) return;
...
function ɵɵdeferPrefetchOnTimer(delay) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "prefetch on timer(".concat(delay, "ms)"));
  }
  if (!shouldAttachTrigger(1, lView, tNode)) return;
...
function ɵɵdeferHydrateOnTimer(delay) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "hydrate on timer(".concat(delay, "ms)"));
  }
  if (!shouldAttachTrigger(2, lView, tNode)) return;
  const hydrateTriggers = getHydrateTriggers(getTView(), tNode);
...
function ɵɵdeferOnHover(triggerIndex, walkUpTimes) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "on hover".concat(walkUpTimes === -1 ? "" : "(<target>)"));
  }
  if (!shouldAttachTrigger(0, lView, tNode)) return;
  renderPlaceholder(lView, tNode);
  if (true) {
...
function ɵɵdeferPrefetchOnHover(triggerIndex, walkUpTimes) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "prefetch on hover".concat(walkUpTimes === -1 ? "" : "(<target>)"));
  }
  if (!shouldAttachTrigger(1, lView, tNode)) return;
  const tView = lView[TVIEW];
  const tDetails = getTDeferBlockDetails(tView, tNode);
...
function ɵɵdeferOnInteraction(triggerIndex, walkUpTimes) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "on interaction".concat(walkUpTimes === -1 ? "" : "(<target>)"));
  }
  if (!shouldAttachTrigger(0, lView, tNode)) return;
  renderPlaceholder(lView, tNode);
  if (true) {
...
function ɵɵdeferPrefetchOnInteraction(triggerIndex, walkUpTimes) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "prefetch on interaction".concat(walkUpTimes === -1 ? "" : "(<target>)"));
  }
  if (!shouldAttachTrigger(1, lView, tNode)) return;
  const tView = lView[TVIEW];
  const tDetails = getTDeferBlockDetails(tView, tNode);
...
function ɵɵdeferOnViewport(triggerIndex, walkUpTimes) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "on viewport".concat(walkUpTimes === -1 ? "" : "(<target>)"));
  }
  if (!shouldAttachTrigger(0, lView, tNode)) return;
  renderPlaceholder(lView, tNode);
  if (true) {
...
function ɵɵdeferPrefetchOnViewport(triggerIndex, walkUpTimes) {
  ...
  const tNode = getCurrentTNode();
  if (ngDevMode) {
    trackTriggerForDebugging(lView[TVIEW], tNode, "prefetch on viewport".concat(walkUpTimes === -1 ? "" : "(<target>)"));
  }
  if (!shouldAttachTrigger(1, lView, tNode)) return;
  const tView = lView[TVIEW];
  const tDetails = getTDeferBlockDetails(tView, tNode);
...
function malformedStyleError(text, expecting, index) {
  ...
  throw throwError("Malformed style at location ".concat(index, " in string '") + text.substring(0, index) + "[>>" + text.substring(index, index + 1) + "<<]" + text.slice(index + 1) + "'. Expecting '".concat(expecting, "'."));
}
    ...
    for (const [key, idxSet] of duplicateKeys) {
      if (idxSet.size > 1) {
        ...
        for (let i = 1; i < idx.length; i++) {
          duplicatedKeysMsg.push('key "'.concat(stringifyForError(key), '" at index "').concat(idx[i - 1], '" and "').concat(idx[i], '"'));
        }
      }
    }
  ...
  set(key, value) {
    if (this.kvMap.has(key)) {
      ...
      if (ngDevMode && prevValue === value) {
        throw new Error("Detected a duplicated value ".concat(value, " for the key ").concat(key));
      }
...
function ɵɵrepeaterCreate(index, templateFn, decls, vars, tagName, attrsIndex, trackByFn, trackByUsesComponentInstance, emptyTemplateFn, emptyDecls, emptyVars, emptyTagName, emptyAttrsIndex) {
  performanceMarkFeature("NgControlFlow");
  ngDevMode && assertFunction(trackByFn, "A track expression must be a function, was ".concat(typeof trackByFn, " instead."));
  const lView = getLView();
  const tView = getTView();
...
var LiveCollectionLContainerImpl = class extends LiveCollection {
  ...
  create(index, value) {
    ...
    (_a6 = this.operationsCounter) == null ? void 0 : _a6.recordCreate();
    return embeddedLView;
  }
  destroy(lView) {
    var _a6;
    destroyLView(lView[TVIEW], lView);
    (_a6 = this.operationsCounter) == null ? void 0 : _a6.recordDestroy();
  }
  updateValue(index, value) {
  ...
  reset() {
    ...
    (_a6 = this.operationsCounter) == null ? void 0 : _a6.reset();
  }
  updateIndexes() {
...
function ɵɵrepeater(collection) {
  ...
  try {
    ...
    if (ngDevMode && metadata.trackByFn === ɵɵrepeaterTrackByIdentity && ((_a6 = liveCollection.operationsCounter) == null ? void 0 : _a6.wasReCreated(liveCollection.length)) && isViewExpensiveToRecreate(getExistingLViewFromLContainer(lContainer, 0))) {
      const message = formatRuntimeError(-956, "The configured tracking expression (track by identity) caused re-creation of the entire collection of size ".concat(liveCollection.length, ". ") + 'This is an expensive operation requiring destruction and subsequent creation of DOM nodes, directives, components etc. Please review the "track expression" and make sure that it uniquely identifies items in a collection.');
      console.warn(message);
    }
...
function listenToOutput(tNode, lView, directiveIndex, lookupName, eventName, listenerFn) {
  ...
  if (ngDevMode && !isOutputSubscribable(output2)) {
    throw new Error("@Output ".concat(propertyName, " not initialized in '").concat(instance.constructor.name, "'."));
  }
...
function listenerInternal(tView, lView, renderer, tNode, eventName, listenerFn, eventTargetResolver) {
  ...
  if (processOutputs) {
    const outputConfig = (_a6 = tNode.outputs) == null ? void 0 : _a6[eventName];
...
function ɵɵattachSourceLocations(templatePath, locations) {
  ...
  for (const [index, offset, line, column] of locations) {
    ...
    if (!node.hasAttribute(attributeName)) {
      const attributeValue = "".concat(templatePath, "@o:").concat(offset, ",l:").concat(line, ",c:").concat(column);
...
function ɵɵpipe(index, pipeName) {
  ...
  if (tView.firstCreatePass) {
    ...
    if (pipeDef.onDestroy) {
      ((_a6 = tView.destroyHooks) != null ? _a6 : tView.destroyHooks = []).push(adjustedIndex, pipeDef.onDestroy);
    }
  } else {
...
function getMultipleMatchingPipesMessage(name) {
  ...
  const componentInfoMessage = context ? " in the '".concat(context.constructor.name, "' component") : "";
...
function ɵɵgetReplaceMetadataURL(id, timestamp, base) {
  const url = "./@ng/component?c=".concat(id, "&t=").concat(encodeURIComponent(timestamp));
...
function clearRendererCache(factory, def) {
  var _a6;
  (_a6 = factory.componentReplaced) == null ? void 0 : _a6.call(factory, def.id);
}
...
function executeWithInvalidateFallback(importMeta, id, callback) {
  ...
  try {
    ...
    if (id !== null && error.message) {
      ...
      (_b2 = (_a6 = importMeta == null ? void 0 : importMeta.hot) == null ? void 0 : _a6.send) == null ? void 0 : _b2.call(_a6, "angular:invalidate", {
        id,
        message: toLog,
        error: true
      });
...
function directiveMetadata(type, metadata) {
  ...
  return {
    ...
    hostDirectives: ((_a6 = metadata.hostDirectives) == null ? void 0 : _a6.map((directive) => typeof directive === "function" ? {
      directive
    } : directive)) || null
  };
}
...
function compileNgModuleFactory(injector, options, moduleType) {
  ...
  const compilerProviders = compilerOptions.flatMap((option) => {
    var _a6;
    return (_a6 = option.providers) != null ? _a6 : [];
  });
...
var _NgZoneChangeDetectionScheduler = class _NgZoneChangeDetectionScheduler {
  ...
  ngOnDestroy() {
    var _a6;
    (_a6 = this._onMicrotaskEmptySubscription) == null ? void 0 : _a6.unsubscribe();
  }
};
...
function getNgZoneOptions(options) {
  ...
  return {
    ...
    shouldCoalesceEventChangeDetection: (_a6 = options == null ? void 0 : options.eventCoalescing) != null ? _a6 : false,
...
var _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  constructor() {
    ...
    __publicField(this, "disableScheduling", (_a4 = inject(ZONELESS_SCHEDULER_DISABLED, {
      optional: true
    })) != null ? _a4 : false);
    ...
    __publicField(this, "angularZoneId", this.zoneIsDefined ? (_b = this.ngZone._inner) == null ? void 0 : _b.get(angularZoneInstanceIdProperty) : null);
  ...
  notify(source) {
    ...
    this.appRef.tracingSnapshot = (_b2 = (_a6 = this.tracing) == null ? void 0 : _a6.snapshot(this.appRef.tracingSnapshot)) != null ? _b2 : null;
  ...
  cleanup() {
    ...
    (_a6 = this.cancelScheduledCallback) == null ? void 0 : _a6.call(this);
...
var _ImagePerformanceWarning = class _ImagePerformanceWarning {
  constructor() {
    ...
    __publicField(this, "options", inject(IMAGE_CONFIG));
    __publicField(this, "lcpImageUrl");
  }
  start() {
    var _a6, _b2;
    if (typeof PerformanceObserver === "undefined" || ((_a6 = this.options) == null ? void 0 : _a6.disableImageSizeWarning) && ((_b2 = this.options) == null ? void 0 : _b2.disableImageLazyLoadWarning)) {
      return;
    }
    ...
    if (win) {
      ...
      const setup = () => {
        ...
        if (doc.readyState === "complete") {
          ...
          (_a7 = this.window) == null ? void 0 : _a7.addEventListener("load", waitToScan, {
            once: true
          });
        }
      };
  ...
  ngOnDestroy() {
    var _a6;
    (_a6 = this.observer) == null ? void 0 : _a6.disconnect();
  }
  initPerformanceObserver() {
    ...
    const observer = new PerformanceObserver((entryList) => {
      ...
      const imgSrc = (_b2 = (_a6 = lcpElement.element) == null ? void 0 : _a6.src) != null ? _b2 : "";
  ...
  scanImages() {
    ...
    images.forEach((image) => {
      var _a7, _b2;
      if (!((_a7 = this.options) == null ? void 0 : _a7.disableImageSizeWarning)) {
    ...
    if (lcpElementFound && !lcpElementLoadedCorrectly && this.lcpImageUrl && !((_a6 = this.options) == null ? void 0 : _a6.disableImageLazyLoadWarning)) {
...
function logOversizedImageWarning(src) {
  console.warn(formatRuntimeError(-913, "An image with src ".concat(src, " has intrinsic file dimensions much larger than its ") + "rendered size. This can negatively impact application loading performance. For more information about addressing or disabling this warning, see https://angular.dev/errors/NG0913"));
}
...
function getPlatform() {
  var _a6;
  return (_a6 = _platformInjector == null ? void 0 : _platformInjector.get(PlatformRef)) != null ? _a6 : null;
}
function destroyPlatform() {
  var _a6;
  (_a6 = getPlatform()) == null ? void 0 : _a6.destroy();
}
...
var DebugNgZoneForCheckNoChanges = class extends NgZone {
  constructor(checkNoChangesMode) {
    ...
    __publicField(this, "checkNoChangesMode");
    __publicField(this, "applicationRef");
    __publicField(this, "scheduler");
    __publicField(this, "errorHandler");
    __publicField(this, "injector", inject(EnvironmentInjector));
...
var DebugElement = class extends DebugNode {
  ...
  get styles() {
    var _a6;
    const element = this.nativeElement;
    return (_a6 = element == null ? void 0 : element.style) != null ? _a6 : {};
  }
  /**
  ...
  const providers = [{
    ...
    useFactory: () => {
      ...
      if (true) {
        ...
        isEnabled = !!((_a6 = window._ejsas) == null ? void 0 : _a6[appId]);
      }
      if (isEnabled) {
      ...
      useFactory: () => {
        ...
        return () => {
          ...
          appRef.whenStable().then(() => {
            ...
            const jsActionMap = injector.get(JSACTION_BLOCK_ELEMENT_MAP);
            (_a6 = jsActionMap.get(EAGER_CONTENT_LISTENERS_KEY)) == null ? void 0 : _a6.forEach(removeListeners);
...
function invokeRegisteredReplayListeners(injector, event, currentTarget) {
  var _a6;
  const blockName = (_a6 = currentTarget && currentTarget.getAttribute(DEFER_BLOCK_SSR_ID_ATTRIBUTE)) != null ? _a6 : "";
...
function serializeLContainer(lContainer, tNode, lView, parentDeferBlockId, context) {
  ...
  for (let i = CONTAINER_HEADER_OFFSET; i < lContainer.length; i++) {
    ...
    if (!serializedView) {
      ...
      if (isDeferBlock(lView[TVIEW], tNode)) {
        ...
        if (context.isIncrementalHydrationEnabled && tDetails.hydrateTriggers !== null) {
          const deferBlockId = "d".concat(context.deferBlocks.size);
    ...
    if (views.length > 0 && currentViewAsString === lastViewAsString) {
      ...
      (_a6 = previousView[MULTIPLIER]) != null ? _a6 : previousView[MULTIPLIER] = 1;
...
function appendSerializedNodePath(ngh, tNode, lView, excludedParentNodes) {
  var _a6, _b2, _c2;
  const noOffsetIndex = tNode.index - HEADER_OFFSET;
  (_a6 = ngh[NODES]) != null ? _a6 : ngh[NODES] = {};
...
function appendDisconnectedNodeIndex(ngh, tNodeOrNoOffsetIndex) {
  ...
  (_a6 = ngh[DISCONNECTED_NODES]) != null ? _a6 : ngh[DISCONNECTED_NODES] = [];
...
function serializeLView(lView, parentDeferBlockId = null, context) {
  ...
  for (let i = HEADER_OFFSET; i < tView.bindingStartIndex; i++) {
    ...
    if (i18nData) {
      (_a6 = ngh[I18N_DATA]) != null ? _a6 : ngh[I18N_DATA] = {};
...
function componentUsesShadowDomEncapsulation(lView) {
  var _a6;
  const instance = lView[CONTEXT];
  return (instance == null ? void 0 : instance.constructor) ? ((_a6 = getComponentDef(instance.constructor)) == null ? void 0 : _a6.encapsulation) === ViewEncapsulation.ShadowDom : false;
}
...
function annotateDeferBlockAnchorForHydration(comment, deferBlockId) {
  comment.textContent = "ngh=".concat(deferBlockId);
}
...
function printHydrationStats(injector) {
  const console2 = injector.get(Console);
  const message = "Angular hydrated ".concat(ngDevMode.hydratedComponents, " component(s) ") + "and ".concat(ngDevMode.hydratedNodes, " node(s), ") + "".concat(ngDevMode.componentsSkippedHydration, " component(s) were skipped. ") + (isIncrementalHydrationEnabled(injector) ? "".concat(ngDevMode.deferBlocksWithIncrementalHydration, " defer block(s) were configured to use incremental hydration. ") : "") + "Learn more at https://angular.dev/guide/hydration.";
...
function labels(label) {
  const labelName = "".concat(PERFORMANCE_MARK_PREFIX, ":").concat(label);
  return {
    labelName,
    startLabel: "start:".concat(labelName),
    endLabel: "end:".concat(labelName)
  };
}
...
function computed(computation, options) {
  ...
  if (ngDevMode) {
    getter.toString = () => "[Computed: ".concat(getter(), "]");
...
var _MicrotaskEffectScheduler = class _MicrotaskEffectScheduler extends ZoneAwareEffectScheduler {
  constructor() {
    super(...arguments);
    __publicField(this, "pendingTasks", inject(PendingTasksInternal));
    __publicField(this, "taskId", null);
  }
  schedule(effect2) {
...
var BASE_EFFECT_NODE = (() => __spreadProps(__spreadValues({}, REACTIVE_NODE), {
  ...
  run() {
    ...
    const registerCleanupFn = (cleanupFn) => {
      var _a6;
      return ((_a6 = this.cleanupFns) != null ? _a6 : this.cleanupFns = []).push(cleanupFn);
    };
  ...
  maybeCleanup() {
    var _a6;
    if (!((_a6 = this.cleanupFns) == null ? void 0 : _a6.length)) {
      return;
    }
    try {
...
var VIEW_EFFECT_NODE = (() => __spreadProps(__spreadValues({}, BASE_EFFECT_NODE), {
  ...
  destroy() {
    ...
    this.onDestroyFn();
    this.maybeCleanup();
    (_a6 = this.view[EFFECTS]) == null ? void 0 : _a6.delete(this);
  }
}))();
function createViewEffect(view, notifier, fn) {
  ...
  node.fn = fn;
  (_a6 = view[EFFECTS]) != null ? _a6 : view[EFFECTS] = /* @__PURE__ */ new Set();
...
function upgradeLinkedSignalGetter(getter) {
  if (ngDevMode) {
    getter.toString = () => "[LinkedSignal: ".concat(getter(), "]");
  }
...
function resource(options) {
  ...
  const request = (_a6 = options.request) != null ? _a6 : () => null;
...
var BaseWritableResource = class {
  constructor(value) {
    ...
    __publicField(this, "isLoading", computed(() => this.status() === ResourceStatus.Loading || this.status() === ResourceStatus.Reloading));
    this.value = value;
...
var ResourceImpl = class extends BaseWritableResource {
  constructor(request, loaderFn, defaultValue, equal, injector) {
    super(
      ...
      computed(() => {
        var _a6, _b2;
        const streamValue = (_b2 = (_a6 = this.state()).stream) == null ? void 0 : _b2.call(_a6);
    ...
    __publicField(this, "error", computed(() => {
      var _a6, _b2;
      const stream = (_b2 = (_a6 = this.state()).stream) == null ? void 0 : _b2.call(_a6);
  ...
  abortInProgressLoad() {
    ...
    untracked2(() => {
      var _a7;
      return (_a7 = this.pendingController) == null ? void 0 : _a7.abort();
    });
    this.pendingController = void 0;
    (_a6 = this.resolvePendingTask) == null ? void 0 : _a6.call(this);
    ...
    if (lView !== null) {
      for (let i = HEADER_OFFSET; i < lView.length; i++) {
        ...
        if (isComponentHost(tNode)) {
          ...
          const name = ((_a6 = def.debugInfo) == null ? void 0 : _a6.className) || def.type.name;
          if (name) {
            return name;
          } else {
            break;
...
function ɵɵngDeclareClassMetadata(decl) {
  var _a6, _b2;
  setClassMetadata(decl.type, decl.decorators, (_a6 = decl.ctorParameters) != null ? _a6 : null, (_b2 = decl.propDecorators) != null ? _b2 : null);
}
...
var AFTER_RENDER_PHASE_EFFECT_NODE = (() => __spreadProps(__spreadValues({}, SIGNAL_NODE), {
  ...
  phaseFn(previousValue) {
    ...
    try {
      for (const cleanupFn of (_a6 = this.cleanup) != null ? _a6 : EMPTY_CLEANUP_SET) {
        cleanupFn();
      }
    } finally {
...
var AfterRenderEffectSequence = class extends AfterRenderSequence {
  constructor(impl, effectHooks, view, scheduler, destroyRef, snapshot = null) {
    ...
    for (const phase of AFTER_RENDER_PHASES) {
      ...
      node.registerCleanupFn = (fn) => {
        var _a6;
        return ((_a6 = node.cleanup) != null ? _a6 : node.cleanup = /* @__PURE__ */ new Set()).add(fn);
      };
  ...
  destroy() {
    ...
    for (const node of this.nodes) {
      for (const fn of (_a6 = node == null ? void 0 : node.cleanup) != null ? _a6 : EMPTY_CLEANUP_SET) {
        fn();
      }
    }
  }
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-TSLSPATE.js.map
