import {
  AnimationBuilder
} from "./chunk-7QH6YDAO.js";
import {
  animate,
  style
} from "./chunk-XG4SIBT5.js";
import {
  DOCUMENT,
  NgClass,
  isPlatformBrowser
} from "./chunk-VCHVTEIK.js";
import {
  ApplicationRef,
...
function getStyleComputedProperty(element, property) {
  ...
  const css = window2 == null ? void 0 : window2.getComputedStyle(element, null);
...
function getOffsetParent(element) {
  ...
  let offsetParent = element == null ? void 0 : element.offsetParent;
  let sibling = void 0;
...
function getFixedPositionOffsetParent(element) {
  ...
  while ((el == null ? void 0 : el.parentElement) && getStyleComputedProperty(el, "transform") === "none") {
    el = el.parentElement;
  }
...
function getBoundingClientRect(element) {
  ...
  const width = (sizes == null ? void 0 : sizes.width) || element.clientWidth || isNumber(rect.right) && isNumber(result.left) && rect.right - result.left || 0;
  const height = (sizes == null ? void 0 : sizes.height) || element.clientHeight || isNumber(rect.bottom) && isNumber(result.top) && rect.bottom - result.top || 0;
...
function getOffsetRectRelativeToArbitraryNode(children, parent, fixedPosition = false) {
  ...
  if (fixedPosition && isHTML) {
    parentRect.top = Math.max((_a = parentRect.top) != null ? _a : 0, 0);
    parentRect.left = Math.max((_b = parentRect.left) != null ? _b : 0, 0);
  }
  const offsets = getClientRect({
    top: ((_c = childrenRect.top) != null ? _c : 0) - ((_d = parentRect.top) != null ? _d : 0) - borderTopWidth,
    left: ((_e = childrenRect.left) != null ? _e : 0) - ((_f = parentRect.left) != null ? _f : 0) - borderLeftWidth,
...
function getViewportOffsetRectRelativeToArtbitraryNode(element, excludeScroll = false) {
  ...
  const offset = {
    top: scrollTop - Number(relativeOffset == null ? void 0 : relativeOffset.top) + Number(relativeOffset == null ? void 0 : relativeOffset.marginTop),
    left: scrollLeft - Number(relativeOffset == null ? void 0 : relativeOffset.left) + Number(relativeOffset == null ? void 0 : relativeOffset.marginLeft),
    width,
    height
  };
...
function computeAutoPlacement(placement, refRect, target, host, allowedPositions = ["top", "bottom", "right", "left"], boundariesElement = "viewport", padding = 0) {
  ...
  const rects = {
    top: {
      width: (_a = boundaries == null ? void 0 : boundaries.width) != null ? _a : 0,
      height: ((_b = refRect == null ? void 0 : refRect.top) != null ? _b : 0) - ((_c = boundaries == null ? void 0 : boundaries.top) != null ? _c : 0)
    },
    right: {
      width: ((_d = boundaries == null ? void 0 : boundaries.right) != null ? _d : 0) - ((_e = refRect == null ? void 0 : refRect.right) != null ? _e : 0),
      height: (_f = boundaries == null ? void 0 : boundaries.height) != null ? _f : 0
    },
    bottom: {
      width: (_g = boundaries == null ? void 0 : boundaries.width) != null ? _g : 0,
      height: ((_h = boundaries == null ? void 0 : boundaries.bottom) != null ? _h : 0) - ((_i = refRect == null ? void 0 : refRect.bottom) != null ? _i : 0)
    },
    left: {
      width: ((_j = refRect.left) != null ? _j : 0) - ((_k = boundaries == null ? void 0 : boundaries.left) != null ? _k : 0),
      height: (_l = boundaries == null ? void 0 : boundaries.height) != null ? _l : 0
    }
  };
...
function getOffsets(data) {
  ...
  return {
    ...
    left: Math.floor((_a = data.offsets.target.left) != null ? _a : 0),
    top: Math.round((_b = data.offsets.target.top) != null ? _b : 0),
    bottom: Math.round((_c = data.offsets.target.bottom) != null ? _c : 0),
    right: Math.floor((_d = data.offsets.target.right) != null ? _d : 0)
  };
}
...
function getOuterSizes(element) {
  const window2 = element.ownerDocument.defaultView;
  const styles = window2 == null ? void 0 : window2.getComputedStyle(element);
  const x = parse(styles == null ? void 0 : styles.marginTop) + parse(styles == null ? void 0 : styles.marginBottom);
  const y = parse(styles == null ? void 0 : styles.marginLeft) + parse(styles == null ? void 0 : styles.marginRight);
  return {
...
function getTargetOffsets(target, hostOffsets, position) {
  ...
  targetOffsets[mainSide] = ((_a = hostOffsets[mainSide]) != null ? _a : 0) + hostOffsets[measurement] / 2 - targetRect[measurement] / 2;
  targetOffsets[secondarySide] = placement === secondarySide ? ((_b = hostOffsets[secondarySide]) != null ? _b : 0) - targetRect[secondaryMeasurement] : (_c = hostOffsets[getOppositePlacement(secondarySide)]) != null ? _c : 0;
  return targetOffsets;
}
function isModifierEnabled(options, modifierName) {
  var _a;
  return !!((_a = options.modifiers[modifierName]) == null ? void 0 : _a.enabled);
}
...
function arrow(data) {
  ...
  if (((_a = data.offsets.host[opSide]) != null ? _a : 0) - arrowElementSize < ((_b = targetOffsets[side]) != null ? _b : 0)) {
    targetOffsets[side] -= ((_c = targetOffsets[side]) != null ? _c : 0) - (((_d = data.offsets.host[opSide]) != null ? _d : 0) - arrowElementSize);
  }
  if (Number(data.offsets.host[side]) + Number(arrowElementSize) > ((_e = targetOffsets[opSide]) != null ? _e : 0)) {
    targetOffsets[side] += Number(data.offsets.host[side]) + Number(arrowElementSize) - Number(targetOffsets[opSide]);
  }
  targetOffsets = getClientRect(targetOffsets);
  const css = getStyleComputedProperty(data.instance.target);
  const targetMarginSide = parseFloat(css["margin".concat(sideCapitalized)]) || 0;
  const targetBorderSide = parseFloat(css["border".concat(sideCapitalized, "Width")]) || 0;
  let center;
  ...
  let sideValue = center - ((_f = targetOffsets[side]) != null ? _f : 0) - targetMarginSide - targetBorderSide;
...
function flip(data) {
  ...
  flipOrder.forEach((step, index) => {
    ...
    const overlapsRef = placement === "left" && Math.floor((_a = data.offsets.target.right) != null ? _a : 0) > Math.floor((_b = data.offsets.host.left) != null ? _b : 0) || placement === "right" && Math.floor((_c = data.offsets.target.left) != null ? _c : 0) < Math.floor((_d = data.offsets.host.right) != null ? _d : 0) || placement === "top" && Math.floor((_e = data.offsets.target.bottom) != null ? _e : 0) > Math.floor((_f = data.offsets.host.top) != null ? _f : 0) || placement === "bottom" && Math.floor((_g = data.offsets.target.top) != null ? _g : 0) < Math.floor((_h = data.offsets.host.bottom) != null ? _h : 0);
    const overflowsLeft = Math.floor((_i = data.offsets.target.left) != null ? _i : 0) < Math.floor((_j = boundaries.left) != null ? _j : 0);
    const overflowsRight = Math.floor((_k = data.offsets.target.right) != null ? _k : 0) > Math.floor((_l = boundaries.right) != null ? _l : 0);
    const overflowsTop = Math.floor((_m = data.offsets.target.top) != null ? _m : 0) < Math.floor((_n = boundaries.top) != null ? _n : 0);
    const overflowsBottom = Math.floor((_o = data.offsets.target.bottom) != null ? _o : 0) > Math.floor((_p = boundaries.bottom) != null ? _p : 0);
...
function preventOverflow(data) {
  ...
  const boundaries = getBoundaries(
    ...
    0,
    // padding
    ((_a = data.options.modifiers.preventOverflow) == null ? void 0 : _a.boundariesElement) || "scrollParent",
    false
    // positionFixed
  );
  ...
  const check = {
    primary(placement) {
      ...
      if (((_a2 = data.offsets.target[placement]) != null ? _a2 : 0) < ((_b = boundaries[placement]) != null ? _b : 0)) {
        value = Math.max((_c = data.offsets.target[placement]) != null ? _c : 0, (_d = boundaries[placement]) != null ? _d : 0);
      }
      return {
        [placement]: value
      };
    ...
    secondary(placement) {
      ...
      if (((_a2 = data.offsets.target[placement]) != null ? _a2 : 0) > ((_b = boundaries[placement]) != null ? _b : 0)) {
        value = Math.min((_c = data.offsets.target[mainSide]) != null ? _c : 0, ((_d = boundaries[placement]) != null ? _d : 0) - data.offsets.target[measurement]);
      }
      return {
        [mainSide]: value
      };
  ...
  if (shiftVariation) {
    ...
    const shiftOffsets = {
      start: {
        ...
        [side]: ((_a = host[side]) != null ? _a : 0) + host[measurement] - target[measurement]
      }
    };
...
var ComponentLoader = class {
  ...
  hide(id) {
    ...
    (_a = componentEl.parentNode) == null ? void 0 : _a.removeChild(componentEl);
    (_c = (_b = this._contentRef) == null ? void 0 : _b.componentRef) == null ? void 0 : _c.destroy();
    if (this._viewContainerRef && ((_d = this._contentRef) == null ? void 0 : _d.viewRef)) {
      this._viewContainerRef.remove(this._viewContainerRef.indexOf(this._contentRef.viewRef));
    }
    (_f = (_e = this._contentRef) == null ? void 0 : _e.viewRef) == null ? void 0 : _f.destroy();
    (_g = this._componentRef) == null ? void 0 : _g.destroy();
  ...
  listen(listenOpts) {
    ...
    listenOpts.target = listenOpts.target || ((_a = this._elementRef) == null ? void 0 : _a.nativeElement);
  ...
  _subscribePositioning() {
    ...
    this.onShown.subscribe(() => {
      ...
      this._posService.position({
        element: (_a = this._componentRef) == null ? void 0 : _a.location,
  ...
  _getContentRef(content, context, initialState) {
    ...
    const nodes = this._renderer ? [this._renderer.createText("".concat(content))] : [];
