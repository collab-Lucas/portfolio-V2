...
__publicField(_NoopAnimationDriver, "ɵfac", function NoopAnimationDriver_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NoopAnimationDriver)();
});
__publicField(_NoopAnimationDriver, "ɵprov", ɵɵdefineInjectable({
 ...
 */
__publicField(AnimationDriver, "NOOP", new NoopAnimationDriver());
...
function warnTriggerBuild(name, warnings) {
  console.warn('The animation trigger "'.concat(name, '" has built with the following warnings:').concat(createListOfWarnings(warnings)));
}
function warnRegister(warnings) {
  console.warn("Animation built with the following warnings:".concat(createListOfWarnings(warnings)));
}
...
var TransitionAnimationPlayer = class {
  constructor(namespaceId, triggerName, element) {
    ...
    __publicField(this, "element");
    __publicField(this, "_player", new NoopAnimationPlayer());
...
var _SpecialCasedStyles = class _SpecialCasedStyles {
  constructor(_element, _startStyles, _endStyles) {
    ...
    __publicField(this, "_startStyles");
    __publicField(this, "_endStyles");
    __publicField(this, "_state", 0);
    __publicField(this, "_initialStyles");
...
var WebAnimationsPlayer = class {
  constructor(element, keyframes, options, _specialStyles) {
    ...
    __publicField(this, "keyframes");
    __publicField(this, "options");
    __publicField(this, "_specialStyles");
    ...
    __publicField(this, "_finalKeyframe");
    ...
    __publicField(this, "domPlayer");
    __publicField(this, "time", 0);
    __publicField(this, "parentPlayer", null);
    __publicField(this, "currentSnapshot", /* @__PURE__ */ new Map());
    this.element = element;
    this.keyframes = keyframes;
    this.options = options;
...
var AnimationRendererFactory = class {
  ...
  componentReplaced(componentId) {
    var _a, _b;
    this.engine.flush();
    (_b = (_a = this.delegate).componentReplaced) == null ? void 0 : _b.call(_a, componentId);
  }
};
...
__publicField(_InjectableAnimationEngine, "ɵfac", function InjectableAnimationEngine_Factory(__ngFactoryType__) {
...
__publicField(_BrowserAnimationsModule, "ɵfac", function BrowserAnimationsModule_Factory(__ngFactoryType__) {
...
__publicField(_NoopAnimationsModule, "ɵfac", function NoopAnimationsModule_Factory(__ngFactoryType__) {
