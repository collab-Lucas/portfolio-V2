...
function addServerStyles(doc, appId, inline, external) {
  var _a;
  const elements = (_a = doc.head) == null ? void 0 : _a.querySelectorAll("style[".concat(APP_ID_ATTRIBUTE_NAME, '="').concat(appId, '"],link[').concat(APP_ID_ATTRIBUTE_NAME, '="').concat(appId, '"]'));
  if (elements) {
...
function addBaseHrefToCssSourceMap(baseHref, styles) {
  ...
  return styles.map((cssContent) => {
    ...
    return cssContent.replace(SOURCEMAP_URL_REGEXP, (_, sourceMapUrl) => {
      ...
      return "/*# sourceMappingURL=".concat(resolvedSourceMapUrl, " */");
    });
  });
}
...
var DefaultDomRenderer2 = class {
  ...
  listen(target, event, callback, options) {
    ...
    if (typeof target === "string") {
      ...
      if (!target) {
        throw new RuntimeError(5102, (typeof ngDevMode === "undefined" || ngDevMode) && "Unsupported event target ".concat(target, " for event ").concat(event));
      }
    }
...
function checkNoSyntheticProp(name, nameKind) {
  if (name.charCodeAt(0) === AT_CHARCODE) {
    throw new RuntimeError(5105, "Unexpected synthetic ".concat(nameKind, " ").concat(name, " found. Please make sure that:\n  - Make sure `provideAnimationsAsync()`, `provideAnimations()` or `provideNoopAnimations()` call was added to a list of providers used to bootstrap an application.\n  - There is a corresponding animation configuration named `").concat(name, "` defined in the `animations` field of the `@Component` decorator (see https://angular.dev/api/core/Component#animations)."));
  }
}
...
@angular/platform-browser/fesm2022/browser-D-u-fknz.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-B4EWEIFM.js.map
