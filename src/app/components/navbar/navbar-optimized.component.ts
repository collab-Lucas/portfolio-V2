...
@Component({
  ...
  template: `
    ...
    <app-light-controls
      ...
      (toggleControls)="toggleLightControls($event)"
...
export class NavbarComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  onLightControlChange(event: any) {
    // Déléguer au service ThreeOptimizationService via ThreeService
  ...
  resetLights() {
    // Réinitialiser les lumières aux valeurs par défaut
    // Cette fonctionnalité pourrait être ajoutée au service si nécessaire
