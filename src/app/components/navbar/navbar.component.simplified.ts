...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  ngAfterViewInit() {
    ...
    // Mettre à jour la liste des lumières
  ...
  // Version simplifiée des méthodes de changement de lumière
  onAmbientLightChange(event: Event) {
    const input = event.target as HTMLInputElement;
    this.ambientLightIntensity = parseFloat(input.value);
    // Mise à jour dépendante du nouveau service (à implémenter si nécessaire dans NavbarThreeService)
  }
